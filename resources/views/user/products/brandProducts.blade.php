...
@section('title')
    {{ $searched_brand->name }} - {{ config('app.name') }}
@endsection
        ...
        <div class="row">
            ...
            <div id="content" class="col-md-9 col-sm-8">
                <div class="products-category">
                    <h3 class="title-category ">{{ $searched_brand->name }}</h3>
                    <!-- Filters -->
                    <div class="product-filter product-filter-top filters-panel">
                        <div class="row">
                            ...
                            <div class="short-by-show form-inline text-right col-md-7 col-sm-9 col-xs-12">
                                <form action="{{ route('user.products.brand.show', $searched_brand->id) }}" method="get">
