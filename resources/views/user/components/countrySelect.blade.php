...
<option value="Faroe Islands">{{ __("FaroeIslands") }}</option>
...
<option value="Lao People's Democratic Republic">{{ __("LaoPeople's Democratic Republic") }}</option>
...
<option value="Sri Lanka">{{ __("SriLanka") }}</option>
<option value="Sudan">{{ __("Sudan") }}</option>
<option value="Suriname">{{ __("Suriname") }}</option>
<option value="Svalbard and Jan Mayen">{{ __("Svalbard and JanMayen") }}</option>
...
<option value="Taiwan, Province of China">{{ __("Taiwan, Province of China") }}</option>
...
<option value="Viet Nam">{{ __("VietNam") }}</option> 
<option value="Virgin Islands, British">{{ __("VirginIslands,British") }}</option>
<option value="Virgin Islands, U.S.">{{ __("VirginIslands,U.S") }}.</option>
<option value="Wallis and Futuna">{{ __("WallisandFutuna") }}</option>
<option value="Western Sahara">{{ __("WesternSahara") }}</option>
