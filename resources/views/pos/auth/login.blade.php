      ...
      <div class="row">
        <div class="col-12 col-sm-8 col-md-6 col-lg-6 col-xl-4 mr-auto ml-auto">
          ...
          <div class="card card-primary">
            <div class="card-header"><h4>{{ __('POS Login Page') }}</h4></div>

            <div class="card-body">
              <form action="{{ route('pos.login') }}" method="post" class="needs-validation" novalidate="">
                @csrf
              ...
              <a href="{{ route('pos.password.request') }}">{{ __('I forgot my password') }}</a>
