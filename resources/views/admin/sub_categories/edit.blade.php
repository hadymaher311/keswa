                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if ($sub_category->image)
                                    style="background-image: url('data:{{ $sub_category->image->meme_type }};base64, {{ base64_encode(file_get_contents($sub_category->image->getPath('card'))) }}'); background-repeat: no-repeat;background-size: cover;
