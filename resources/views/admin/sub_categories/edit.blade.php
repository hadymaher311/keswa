                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('sub_categories.update', $sub_category->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en" value="{{ $sub_category->name_en }}" autocomplete="name_en" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="name_ar" type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar" value="{{ $sub_category->name_ar }}" autocomplete="name_ar">
                            ...
                            <div class="col-sm-9">
                                <select name="category" id="category" required class="form-control @error('category') is-invalid @enderror">
                                    ...
                                    @foreach ($categories as $category)
                                        <option @if ($category->id == $sub_category->category_id)
                                            selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if ($sub_category->image)
                                    style="background-image: url('data:{{ $sub_category->image->meme_type }};base64, {{ config('app.env') == 'local' ? base64_encode(file_get_contents($sub_category->image->getPath('card'))) : base64_encode(file_get_contents($sub_category->image->getUrl('card'))) }}'); background-repeat: no-repeat;background-size: cover;
