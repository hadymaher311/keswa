                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('brands.update', $brand->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="name_en" type="text" class="form-control @error('name_en') is-invalid @enderror" name="name_en" value="{{ $brand->name_en }}" autocomplete="name_en" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input id="name_ar" type="text" class="form-control @error('name_ar') is-invalid @enderror" name="name_ar" value="{{ $brand->name_ar }}" autocomplete="name_ar">
                            ...
                            <div class="col-sm-9">
                                <select name="category" id="category" required class="form-control @error('category') is-invalid @enderror">
                                    ...
                                    @foreach ($categories as $category)
                                        <option @if ($category->id == $brand->category_id)
                                            selected
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                ...
                                @if ($brand->image)
                                    style="background-image: url('data:{{ $brand->image->meme_type }};base64, {{ config('app.env') == 'local' ? base64_encode(file_get_contents($brand->image->getPath('card'))) : base64_encode(file_get_contents($brand->image->getUrl('card'))) }}'); background-repeat: no-repeat;background-size: cover;
